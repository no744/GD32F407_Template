...
#define CST816T_EXTI_IRQn						EXTI4_IRQn
#define CST816T_EXTI_Line			 			EXTI_4
#define CST816T_SOURCE				EXTI_SOURCE_GPIOB, EXTI_SOURCE_PIN4
...
#define I2C_TOUCH_WRITE(a, r, d, l)	I2C0_write(a,r,d,l)
#define I2C_TOUCH_READ(a, r, d, l)	I2C0_read(a,r,d,l)
